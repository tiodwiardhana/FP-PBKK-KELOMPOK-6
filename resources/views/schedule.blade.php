...
<body onload="buatId()">
    ...
    <div class="container">
        <div class="jadwal">
            ...
            <ul v-for="studio in jadwal">
                <li>Studio @{{ studio.studio }}</li>
                <li v-for="jam in studio.urutan">

                    <button class="tombol-pilihjadwal" @click="pilihJadwal(studio.label, jam.nomor)">
